...
Selects which variant of B20 to deploy — currently `DEFAULT`, `STABLECOIN`, or `SECURITY`. See the [variant overview](README.md#variant-overview) for what each one bundles.
