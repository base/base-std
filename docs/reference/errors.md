...
| `InsufficientAllowance(address spender, uint256 allowance, uint256 needed)` | `0x192b9e4e` | `spender` does not hold `OPERATOR_ROLE`, and its allowance is less than `needed` for the requested `transferFrom`. |
