...
library StdPrecompiles {
    ...
    // Provisional: the EIP-8130 precompile addresses are not finalized upstream and use the
    // 0x8130... (EIP number) namespace; they may be renumbered when the spec pins concrete values.
    address internal constant TX_CONTEXT_ADDRESS = 0x813000000000000000000000000000000000aa01;
    address internal constant NONCE_MANAGER_ADDRESS = 0x813000000000000000000000000000000000aa02;
