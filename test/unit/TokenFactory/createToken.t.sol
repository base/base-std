...
contract TokenFactoryCreateTokenTest is TokenFactoryTest {
    ...
    function test_createToken_revert_invalidVariant(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_unsupportedVersion(uint8 badVersion, bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_invalidDecimals(uint8 decimals, bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_zeroAdmin_default(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_zeroAdmin_stablecoin(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_zeroAdmin_security(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_missingCurrency(bytes32 salt) public {
        // unimplemented
    }

    /// @notice Verifies security createToken reverts when isin is the empty string
    /// @dev Per-variant required-field check; checks MissingRequiredField() error
    function test_createToken_revert_missingIsin(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_tokenAlreadyExists(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_revert_initCallFailed(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_success_defaultMatchesPrediction(bytes32 salt, uint8 decimals) public {
        // unimplemented
    }
    ...
    function test_createToken_success_stablecoinMatchesPrediction(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_success_securityMatchesPrediction(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_success_emitsTokenCreated(bytes32 salt, uint8 decimals) public {
        // unimplemented
    }
    ...
    function test_createToken_success_executesInitCalls(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_success_encodesVariantByte(bytes32 salt) public {
        // unimplemented
    }
    ...
    function test_createToken_success_encodesDecimalsByte(bytes32 salt, uint8 decimals) public {
        // unimplemented
    }
}
