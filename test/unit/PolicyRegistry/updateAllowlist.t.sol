...
contract PolicyRegistryUpdateAllowlistTest is PolicyRegistryTest {
    ...
    function test_updateAllowlist_revert_incompatiblePolicyType(bool allowed, address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateAllowlist_revert_policyNotFound(uint64 policyId, bool allowed, address[] memory accounts)
        public
    {
        // unimplemented
    }
    ...
    function test_updateAllowlist_success_addsAccounts(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateAllowlist_success_removesAccounts(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateAllowlist_success_idempotentDuplicates(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateAllowlist_success_emitsAllowlistUpdated(bool allowed, address[] memory accounts) public {
        // unimplemented
    }
}
