...
contract PolicyRegistryUpdateBlocklistTest is PolicyRegistryTest {
    ...
    function test_updateBlocklist_revert_incompatiblePolicyType(bool blocked, address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateBlocklist_revert_policyNotFound(uint64 policyId, bool blocked, address[] memory accounts)
        public
    {
        // unimplemented
    }
    ...
    function test_updateBlocklist_success_addsAccounts(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateBlocklist_success_removesAccounts(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateBlocklist_success_idempotentDuplicates(address[] memory accounts) public {
        // unimplemented
    }
    ...
    function test_updateBlocklist_success_emitsBlocklistUpdated(bool blocked, address[] memory accounts) public {
        // unimplemented
    }
}
