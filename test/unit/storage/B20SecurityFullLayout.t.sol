...
import {MockB20SecurityStorage, MockB20RedeemStorage} from "test/lib/mocks/MockB20Storage.sol";
import {PolicyRegistryConstants} from "test/lib/mocks/MockPolicyRegistry.sol";

/// @notice Exhaustive layout spec for the `base.b20.security` and
...
///         in every field via the public `IB20Security` surface, then
...
///         `B20SecurityTest`-derived test contracts.
///
...
contract B20SecurityFullLayoutTest is B20SecurityTest {
    ...
    function test_b20SecurityLayout_success_populatedSnapshotMatchesAllSlots() public {
        ...
        // ============================================================
        //                  base.b20.security namespace
        // ============================================================

        // ---------- sharesToTokensRatio (slot 0) ----------
        assertEq(
            uint256(vm.load(tokenAddr, MockB20SecurityStorage.sharesToTokensRatioSlot())),
            SHARE_RATIO_MARKER,
    ...
    /// @notice Verifies the `base.b20.security` and `base.b20.redeem`
    ...
    ///         property is tested for `base.b20` vs `base.b20.security`
    ...
    function test_b20SecurityLayout_success_namespaceRootsDisjoint() public pure {
        assertTrue(
            MockB20SecurityStorage.STORAGE_LOCATION != MockB20RedeemStorage.STORAGE_LOCATION,
            "base.b20.security and base.b20.redeem must derive to disjoint roots"
        );
    }
