...
contract B20MintTest is B20Test {
    ...
    function test_mint_revert_unauthorized(address caller, uint256 amount) public {
        // unimplemented
    }

    /// @notice Verifies mint reverts when MINT feature is paused
    /// @dev Pause guard; checks ContractPaused(MINT) error
    function test_mint_revert_whenMintPaused(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_mint_revert_supplyCapExceeded(uint256 cap, uint256 amount) public {
        // unimplemented
    }
    ...
    function test_mint_revert_receiverPolicyForbids(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_mint_success_creditsRecipient(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_mint_success_emitsTransferFromZero(uint256 amount) public {
        // unimplemented
    }
}
