...
contract B20TransferFromWithMemoTest is B20Test {
    ...
    function test_transferFromWithMemo_revert_inheritsTransferFromGuards(uint256 amount, bytes32 memo) public {
        // unimplemented
    }
    ...
    function test_transferFromWithMemo_success_movesBalanceAndDecreasesAllowance(uint256 amount, bytes32 memo)
        public
    {
        // unimplemented
    }
    ...
    function test_transferFromWithMemo_success_emitsTransferThenMemo(uint256 amount, bytes32 memo) public {
        // unimplemented
    }

    /// @notice Verifies transferFromWithMemo returns true on success
    /// @dev Matches transferFrom's return-value contract
    function test_transferFromWithMemo_success_returnsTrue(uint256 amount, bytes32 memo) public {
        // unimplemented
    }
}
