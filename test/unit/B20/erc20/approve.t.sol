...
contract B20ApproveTest is B20Test {
    ...
    function test_approve_revert_zeroSpender(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_approve_success_succeedsWhilePaused(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_approve_success_setsAllowance(uint256 amount) public {
        // unimplemented
    }
    ...
    function test_approve_success_emitsApproval(uint256 amount) public {
        // unimplemented
    }

    /// @notice Verifies approve returns true on success
    /// @dev ERC-20 return-value contract
    function test_approve_success_returnsTrue(uint256 amount) public {
        // unimplemented
    }
}
