...
contract B20GetRoleAdminTest is B20Test {
    ...
    ///      that special case is covered implicitly by the updateRoleAdmin-emits test.
    ...
    /// @notice Verifies getRoleAdmin returns the new admin role after updateRoleAdmin
