...
contract B20TransferWithMemoTest is B20Test {
    ...
    function test_transferWithMemo_revert_inheritsTransferGuards(uint256 amount, bytes32 memo) public {
        // unimplemented
    }
    ...
    function test_transferWithMemo_success_movesBalance(uint256 amount, bytes32 memo) public {
        // unimplemented
    }
    ...
    function test_transferWithMemo_success_emitsTransferThenMemo(uint256 amount, bytes32 memo) public {
        // unimplemented
    }

    /// @notice Verifies transferWithMemo returns true on success
    /// @dev Matches transfer's return-value contract
    function test_transferWithMemo_success_returnsTrue(uint256 amount, bytes32 memo) public {
        // unimplemented
    }
}
